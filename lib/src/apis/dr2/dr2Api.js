...
class Dr2Api extends ApiAbstract {
    ...
    handlePhysics(buffer){
        ...
        res.data.sLocalAcceleration = [buffer.readFloatLE(32), buffer.readFloatLE(36), -1 * buffer.readFloatLE(40)];
        res.data.sRideHeight = [buffer.readFloatLE(68)/50, buffer.readFloatLE(72)/50, buffer.readFloatLE(76)/50, buffer.readFloatLE(80)/50];
        //res.data.sRideHeight = [0,0,0];
